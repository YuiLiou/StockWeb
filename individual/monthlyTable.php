<?php
  ...
  /* 20200129 rusiang  新增年營收 Chart 
  /* 20200201 rusiang  修改Chart:比較年EPS&年營收
  /* 20200201 rusiang  新增季營收 Chart
  /* 20200209 rusiang  新增當月/短期/長期營收成長率Chart   
  /**********************************************************************************/ 
  ...
  /*********************************************************************************/
  echo "【成長性分析】<br>";
  echo "<canvas id='monthGrowthChart'></canvas>";
/* 
  // 20200209 sunset by rusiang
  echo "【成長性分析】<br>";
  $months = array(1,3,12);
  foreach ($months as $m) 
  {
...
*/
  ...
  /*********************************************************************************/
  echo "【年營收】<br>";
  echo "<canvas id='yearlyChart'></canvas>";  

  /*********************************************************************************/
  /*【季營收】                                              
  /*********************************************************************************/
  echo "【季營收】<br>";
  echo "<canvas id='seasonChart'></canvas>";  
